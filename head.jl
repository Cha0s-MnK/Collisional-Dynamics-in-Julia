...
global num_name = 1.4 # name number of the saved files
global num_steps = Int(8e3) # number of simulation steps
...
global Timestep = 1.0e4 # maximum timestep (Julian year)
...
#global velocity_dispersion = (10.0 * KMperS)^2
